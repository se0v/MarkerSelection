...
import com.example.markerselection.databinding.FragmentLoseBinding
import com.example.markerselection.databinding.FragmentWinBinding
...
class LoseFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.oneMoreButton.setOnClickListener {view: View ->
            view.findNavController().navigate(
                R.id.action_loseFragment_to_markersFragment
            )
        }
