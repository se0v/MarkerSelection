...
import com.example.markerselection.databinding.FragmentWelcomeScreenBinding
...
class WelcomeScreenFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.letsPlayButton.setOnClickListener{view:View ->
            Navigation.findNavController(view).navigate(R.id.action_welcomeScreenFragment2_to_markersFragment)
        }
